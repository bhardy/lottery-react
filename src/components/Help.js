      ...
      <div className="help__container">
        <article className="help">
          ...
          <p className="help__main-description">
            ...
            and NHL, where teams have unique and accurate odds with differences
            as low as 0.1%
          </p>
          ...
          <ol className="help-steps__list">
            <li>
              <strong>
                You need 14 items that can be randomly drawn. You'll need to
                number said items 1 through 14.
              </strong>{' '}
              In the SBBHL we use 14 ping pong balls in a bingo spinner. You
              could easily number 14 pieces of paper and put them in a hat. You
              could number pigs and let them race. You could number rubber
              duckies and throw them into the ocean and see which 4 wash up
              first. Be creative, or don't, who cares?
            </li>
            <li>
              You need to figure out your odss/probabilities. The NBA uses the
              following:{' '}
              ...
              <br />
              You can do whatever you want, they just{' '}
              <strong>all need to add up to 100%</strong>.
              <em>
            ...
            <li>
              Enter your teams and probabilities into Odds.cool's Setup screen
              and click 'Ready'
            </li>
            <li>
              ...
              Watch your teams' chances at winning update live until the 4th
              number declares the winner.
            </li>
          </ol>
          ...
          <p>
            You can click the stages to go back in time to see how the odds
            adjusted as you drew numbers. You can't draw a ball while you're in
            the past though—if you want to do that you'll need to 'Undo'.
          </p>
          ...
          <p>
            ...
            with garbage browsers all day at work, I'm not going to accommodate
